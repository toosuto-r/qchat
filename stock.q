...
getqt:{[x;u;n] 
  if[like[first r:qt x]"*not found*";:neg[.z.w](`nerw;raze"\033[G",r;enlist n)];
...
buy:{[u;n;c;l;e;s]
  if[like[first q:qt s]"*not found*";:neg[.z.w](`nerw;"\033[GPlease specify a correct sym";enlist n)];
  q:"F"$last[q]except",";
