...
htproc:{" http://twitter.com/hashtag/",1_x except " "}

chat:{[x;y;z]lastmsg::.z.P;bc uvol[key aw],\:"\033[G",uct["[",$[10;string z],"]:"],$[any $["@"in cx:$["c";x];cx:"c"$x:"j"$atproc cx;cx]like/:("*//c*";"*//e*");"j"$pemji[pcols cx],"\033[0m";x],$[x[0]="#";htproc[x];""];};
